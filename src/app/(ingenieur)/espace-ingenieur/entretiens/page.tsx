// Espace ingénieur — Entretiens visio (route /espace-ingenieur/entretiens).
//
// Bug corrigé (21/06) : la page ré-exportait la page éditeur, qui rend la topbar
// éditeur (breadcrumb « ASTRAEOS Admin ») — mauvais espace. On réutilise ici les
// mêmes données réelles (listRecentEntretiens, scopées au cabinet de la session) et
// les composants partagés (PageHero, KpiCard), mais SANS la topbar éditeur, comme
// les autres pages ingénieur. Tout est stylé en Tailwind global (rendu correct).
...
export const metadata = {
  title: "ASTRAEOS · Espace Ingénieur · Entretiens visio",
};
