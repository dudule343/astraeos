...
export function DirigeantTopbar({ current }: { current: string }) {
    ...
    <div className="topbar">
      ...
      <div className="topbar-right">
          ...
          <div className={`date-popover${open ? " open" : ""}`}>
            ...
            <div className="date-popover-section">
              ...
              <div className="date-range-inputs">
                <input type="date" className="date-range-input" defaultValue="2026-04-09" />
                <input type="date" className="date-range-input" defaultValue="2026-05-09" />
              </div>
            </div>
            <div className="date-popover-section">
        ...
        <div className="user-pill">
          ...
          <span className="user-name">Luc THILLIEZ · Dirigeant</span>
        </div>
      </div>
    </div>
  );
